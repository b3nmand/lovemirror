/*
  ...
  1. New Tables
    - `partner_invitations` - For inviting partners to connect
    - `relationships` - To store connections between users
    - `compatibility_scores` - To store compatibility analysis results

  2. Security
    - Enable RLS on all tables
    - Add policies for invitations, relationships, and scores
